...
Ltrace('pbsgCoreUpdated() at Entry', [
  "settings.buttons: ${settings.buttons}",
  "settings.dfltButton: ${settings.dfltButton}",
  "settings.activeButton: ${settings.activeButton}",
  "settings.logLevel: ${settings.logLevel}",
...
Ltrace('pbsgCoreUpdated() Refined Parms', [
  "prevDnis: ${prevDnis}",
  "updatedDnis: ${updatedDnis}",
  "updatedDfltDni: ${updatedDfltDni}",
  "updatedActiveDni: ${updatedActiveDni}",
  "state.logLevel: ${state.logLevel}"
])
...
Ltrace('pbsgCoreUpdated() Before Table', 'n/a')
...
Ltrace('pbsgCoreUpdated() After Table', 'n/a')
